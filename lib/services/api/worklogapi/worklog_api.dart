...
class WorkLogApi {
  ...
  Future<WorkLogStart> realStartTime(int pno, int jmno) async {
    try{
  ...
  Future<WorkLogEnd> realEndTime(int pno, int jmno) async {
    try{

      print("real start time api------------------------");
      final response = await http.get(Uri.parse('$baseUrl/worklog/realEnd?pno=$pno&jmno=$jmno'));
